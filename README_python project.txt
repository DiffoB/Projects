...
View my notebook with detailed steps here: [Top_Paying_Roles.ipynb](Project/Top_paying_roles)
...
```
### Results
TODO: Call the image of the Likelihood of Skills Requested in US Job Postings
...
```
### Results
TODO: Call the image of the Trending Top Skills for Data Analysts in the US
...
```
### Results
TODO: Call the image of the highest paid and most in-demand skills for data analysts in US Job Postings
![The Highest Paid & Most Demanded Skills for Data Analysts in the US](Project/images/highest_paid_and_most_in_demand_skills.png)
...
```
#### Results
![Most Optimal Skills for Data Analyts in the US](Project/images/Most_optimal_skills_for_Data_Analysts_in_the_US_with_colouring_by_technology.png)
